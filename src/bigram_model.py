...
def bigrams_count_to_probabilities(
    ...
    # TODO
    count = bigram_counts.float() + smooth_factor
    total = count.sum(dim=1, keepdim=True)
    return count/total
...
def calculate_log_likelihood(
    ...
    for i in range(len(processed_word) - 1):
        ...
        index_char1 = char_to_index[char1]
        index_char2 = char_to_index[char2]

        prob = bigram_probabilities[index_char1][index_char2]
